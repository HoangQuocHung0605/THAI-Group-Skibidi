...
1. **[Own your output](/handbook/values/#have-ownership--accountability)**: You are responsible for the accuracy, appropriateness, and value of any content you share, regardless of how it was created. As the ultimate author, you should read, understand, and refine comments, code or other artifacts before asking others to review.
   ...
   - **Use [inclusive language](/handbook/values/#inclusive-language--pronouns)**: Review AI outputs for bias and ensure they align with our [Diversity, Inclusion & Belonging](/handbook/values/#diversity-inclusion) value.
   - **[Keep broadcasts short](/handbook/values/#keep-broadcasts-short)**: AI tools can generate verbose and repetitive content. Edit for brevity and clarity, especially in one-to-many communications. Optimize for [efficiency for the right group](/handbook/values/#efficiency-for-the-right-group). Consider your audience's time when deciding what to share.
1. **Protect confidential information**: Be aware of [Data Classification Standards](/handbook/security/policies_and_standards/data-classification-standard/) for the data and AI tooling you're using. Use only approved internal tools for sensitive content.
1. **Maintain authenticity**: Ensure your communications reflect genuine human judgment and align with our [values](/handbook/values/). This is especially important in customer interactions and when [providing feedback](/handbook/values/#give-feedback-effectively).
...
AI tools can enhance [efficiency](/handbook/values/#efficiency), but they don't reduce your responsibility to communicate effectively and professionally.

If you're a recipient of content you think falls short of this guidance (sometimes called "AI slop"), operate on our principles of ["assume positive intent"](/handbook/values/#assume-positive-intent), ["negative feedback is 1-on-1"](/handbook/values/#negative-feedback-is-1-1), and ["give feedback effectively"](/handbook/values/#give-feedback-effectively).
...
- For critical production issues, check if there is a related ongoing incident in [`#incidents-dotcom`](https://gitlab.enterprise.slack.com/archives/C08FMPK1DDF). If there is none, please [report an incident](/handbook/engineering/infrastructure-platforms/incident-management/#reporting-an-incident).
...
1. Put your planned away time including holidays, vacation, travel time, and other leave in your own calendar. Please see [Communicating your time off](/handbook/people-group/time-off-and-absence/time-off-types/) for more.
1. Set your working hours in your Google Calendar settings.
1. Utilize Time Off by Deel to keep other GitLab team members aware of your [planned time away](/handbook/people-group/time-off-and-absence/time-off-types/) within Slack.
