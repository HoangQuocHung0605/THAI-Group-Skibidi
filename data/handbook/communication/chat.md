...
To get in touch with the [e-group](/handbook/company/team/?departmentOrDivision=Executive) on Slack, you can use the following channels. When in doubt, you can use the general `#e-group` channel to reach out to the entire group.
...
| [`#loc_idaho`](https://gitlab.enterprise.slack.com/archives/C0A7PB855D1) | GitLab team members in Idaho |
