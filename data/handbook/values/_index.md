...
We use a lot of [text-based communication](/handbook/company/culture/all-remote/), and if you know the person behind the text, it will be easier to prevent conflicts.
...
There is a lot of good in [this article](https://www.bobsutton.org/2006/10/the_no_asshole_-6/) about not wanting jerks on our team, but we believe that **jerk** is a label for behavior rather than an inherent classification of a person.  We avoid classifications.
...
We hold blameless [root cause analyses](https://www.etsy.com/codeascraft/blameless-postmortems/) and [retrospectives](/handbook/engineering/careers/management/group-retrospectives/) for stakeholders to speak up without fear of punishment or retribution.
...
For example, prefer "Hi everybody" or "Hi people" to "Hi guys", and "they" instead of "he/she". While there are several good guides from folks like [Buffer](https://buffer.com/resources/inclusive-language-tech/), [APA](https://www.apa.org/about/apa/equity-diversity-inclusion/language-guidelines) and [The Northern Ireland Civil Services](https://www.finance-ni.gov.uk/publications/civil-service-inclusive-language-guide) on using inclusive language, we don't keep an exhaustive list.
...
- [Development stage progression](https://docs.gitlab.com/policy/development_stages_support/) (such as experiment to beta)
- Release
- Announcement

While [development stages](https://docs.gitlab.com/policy/development_stages_support/) can be used to indicate release progress, is not itself iteration.
...
At GitLab, we rarely mark any content or proposals as drafts. Everything is always in draft and subject to change. When everything is in draft, contributions from team members as well as the wider community are welcomed. By having everything in draft and [assuming others have low context](/handbook/communication/#low-context), confusion can be reduced as people have shared access to information.
...
We make our values public for [many reasons](/handbook/company/culture/all-remote/). There is great power and efficiency in teams who share company values. Concealing values until *after* someone is hired into an organization is not a wise strategy.
...
All CREDIT values competencies are outlined by role in the [Job Levels](https://docs.google.com/spreadsheets/d/1kcDb-A2uwchPtTNSJON65BdqS9P0KQmNz0fbNMZMt_M/edit?gid=819074618#gid=819074618) resource.
...
- [All-remote](/handbook/company/culture/all-remote/) isn't a value. It is something we do because it helps to [practice our values](/handbook/company/culture/all-remote/) of transparency, efficiency, results, and diversity, inclusion & belonging.
