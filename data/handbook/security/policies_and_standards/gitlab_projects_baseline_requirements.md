...
See [Note on usage of Code Owners](/handbook/security/policies_and_standards/gitlab_projects_baseline_requirements/#note-on-usage-of-code-owners)
...
1. Strongly consider [creating a threat model](/handbook/security/product-security/security-platforms-architecture/application-security/threat-modeling/howto/) for the project.
1. Consider requesting an [AppSec review](/handbook/security/product-security/security-platforms-architecture/application-security/appsec-reviews/) when the project is more established.
1. Reach out to the AppSec team (`@gitlab-com/gl-security/appsec` and `#security_help`) for any further questions.

## References

- [GitLab Repositories](/handbook/engineering/workflow/gitlab-repositories/#creating-a-new-project) (for guidance on creating a new project)
