...
description: 'Documentation on Zendesk knowledge center'
date: 2025-12-23
---
...
- Always ensure [Current knowledge center settings](#current-knowledge-center-settings) is updated on this page if you change the knowledge center settings

{{% /alert %}}

To modify the knowledge center settings:

1. [Access the knowledge center](#accessing-the-knowledge-center)
...
1. Click the relevant button to save the changes (it can vary from page to page)
