...
See the [dedicated page](/handbook/security/product-security/security-platforms-architecture/application-security/runbooks/triage-rotation/) to read about our Triage Rotation process.

### HackerOne Process

See the [dedicated page](/handbook/security/product-security/psirt/runbooks/hackerone-process/) to read about our HackerOne process.

### Security Dashboard Review

See the [dedicated page](/handbook/security/product-security/security-platforms-architecture/application-security/runbooks/security-dashboard-review/) to read about our dashboard review process.
...
1. If an issue does not have `~keep confidential`, remove sensitive information from the description and comments, e.g.
   ...
   1. Information which our [Data Classification Standard](/handbook/security/policies_and_standards/data-classification-standard/) and [SAFE framework](/handbook/legal/safe-framework/) say to not disclose
...
- Some issues should be assigned `~keep confidential`. These issues include:
  ...
  - Issues that contain information or relate to another wider initiative that fixes a larger problem but cannot be disclosed yet
...
if and only if the issue is [determined to be a vulnerability](product-security/security-platforms-architecture/application-security/vulnerability-management/#vulnerability-vs-feature-vs-bug).
...
directly or through our [HackerOne Bug Bounty Program](/handbook/security/product-security/psirt/runbooks/hackerone-process/).
