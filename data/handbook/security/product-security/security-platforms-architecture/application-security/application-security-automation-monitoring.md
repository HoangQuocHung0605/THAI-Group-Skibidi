...
- [Security MR Reviewer Flow](https://gitlab.com/components/agents-and-flows/appsec-security-mr-reviewer/) is an experimental automated application security review flow that can perform AI-driven security code reviews on merge requests in GitLab projects.
...
- [Package Hunter](https://gitlab.com/gitlab-org/security-products/package-hunter) detects suspicious activity in dependencies at runtime ([related runbook](/handbook/security/product-security/security-platforms-architecture/application-security/runbooks/investigating-package-hunter-findings/))
