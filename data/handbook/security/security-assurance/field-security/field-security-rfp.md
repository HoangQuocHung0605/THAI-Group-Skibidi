...
1. The Sales Team Member should review content in GitLab's [product documentation](https://docs.gitlab.com) for any questions related to Product features. Other helpful resources include [blog posts](https://about.gitlab.com/blog/) and [release posts](https://about.gitlab.com/releases/categories/releases/).
1. The team is encouraged to make use of [Glean](/handbook/business-technology/enterprise-applications/guides/glean-guide/) and [GitLab Duo](https://docs.gitlab.com/user/duo_agent_platform/) to answer questions. Ensure you review and validate the responses before distirbuting them externally.
