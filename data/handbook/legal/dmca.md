...
The information below covers the reporting period from July 1, 2025 to December 31, 2025.

As of December 2025, GitLab.com has approximately 2,140,000 monthly average active recipients of the service in the European Union.

For non-logged-in users, our tracking relies on standard web analytics technologies. This methodology has inherent limitations, as users who access GitLab from multiple devices or browsers, or who have certain privacy settings enabled, may be counted more than once in our calculations. Conversely, multiple users sharing the same device might be undercounted. This means our reported number represents our best estimate of unique recipients based on available data. This approach is consistent with the DSA's guidance that providers should not perform specific tracking of individuals online to avoid double counting. During the current reporting period, GitLab identified an anomalous increase in traffic patterns affecting logged‑out visitor counts on gitlab.com, which is reflected in the reported figure. GitLab is reviewing and improving its measurement methodology to better account for automated traffic and intends to implement these improvements for future reporting periods.
