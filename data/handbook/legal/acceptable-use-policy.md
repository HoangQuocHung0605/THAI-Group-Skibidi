...
1. So our services, and those of others, run securely, and without disruption, you must not:
    - Do anything to compromise, overburden, or otherwise impair our services or those of others, including using our services to mine or demonstrate proof-of-work for a cryptocurrency or blockchain, for the primary purpose of distributing content, or for repeatedly or systematically bulk exporting your GitLab data except where permitted by applicable law. By "your GitLab data," we mean all code and other data provided by you or on your behalf through your use of GitLab.
...
1. In addition, if you use any of our services that are based on artificial intelligence (including machine learning) technologies (our "AI-powered services"), you cannot use these services:
    ...
    - In any of the following fields:
      ...
      - Provision of legal or financial services or any other tailored advice that requires a license, without appropriate involvement by a licensed professional.
