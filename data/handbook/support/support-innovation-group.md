...
description:  The Support Innovation Group (SIG) is a cross-functional initiative at GitLab bridging Support, IT, and Product to drive AI-powered workflows, knowledge, and support innovation.
---
...
- Attend bi-weekly meetings plus async intake contributions. This is a focused role within Support to help drive our processes and projects (not a second job). The expected level of engagement is roughly 3-4 hours per week on a regular basis (less than 10% of their time), with a potential for additional time when testing (UAT, Proof of Concepts) or any major functionality, etc.
