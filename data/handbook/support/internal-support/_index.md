...
1. In sensitive cases where asking a customer to open a ticket would aggravate a situation, you can open a Support ticket on behalf of the customer via [Zendesk Global Internal Request form](https://gitlab-internal.zendesk.com/hc/en-us/requests/new?ticket_form_id=22783651259548). To do this, choose `Customer Support Internal Requests`, then in the `What is this request concerning?` dropdown select `Create a support ticket on behalf of a prospect or customer`. Fill in all required fields with as much information as you can provide.
...
A Zendesk Light Agent account is required to view Support Tickets and can be obtained without manager approval. To request a Zendesk Global light agent account, please request it via [Lumos](https://app.lumosidentity.com/app_store?domainAppId=1115644&permissionIds=6102631).
...
Typically there are two types of internal requests (IR):

1. Customer Support Internal Requests
See [Gratis Support](../gratis-support/) for more details.

1. L&R Internal Requests
All internal requests regarding licensing, subscriptions, and trials should be filed using the GitLab Support Internal Zendesk instance for either [Global Support](https://gitlab-internal.zendesk.com/hc/en-us/requests/new?ticket_form_id=22783840298780) or [US Gov Support](https://gitlab-federal-internal.zendesk.com/hc/en-us/requests/new?ticket_form_id=41826474429588). Ensure that you have selected the `L&R Internal Request` form rather than `Customer Support Internal Request` as these route to separate queues and may otherwise cause delays for you and your customer or prospect.
...
- you've experienced and verified a [loss of functionality over a period lasting more than 5 minutes](/handbook/engineering/infrastructure-platforms/incident-management/#definition-of-outage-vs-degraded-vs-disruption-and-when-to-communicate)
- you suspect a [high severity bug](/handbook/engineering/infrastructure-platforms/incident-management/#high-severity-bugs) has been deployed to GitLab.com

[More about GitLab.com incidents](/handbook/engineering/infrastructure-platforms/incident-management/)
