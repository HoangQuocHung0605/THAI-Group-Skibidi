...
|-------------| ---------------- | ------------------------|
| FY26-Q4 (Current) | 6 | [STM#7281](https://gitlab.com/gitlab-com/support/support-team-meta/-/issues/7281) |
| FY26-Q3 | 9 | Not calculated until Q4 so not notified |
| FY26-Q2 | 9 | Not calculated until Q4 so not notified |
  ...
  **Building the Zendesk Explore report**
  ...
  1. Chart configuration > Display format:
     - D_COUNT(Tickets updated) > Advanced:
       ...
       ELIF (D_COUNT(Tickets updated) = NULL) THEN
       {
           "backgroundColor": ""
       }
       ELSE
