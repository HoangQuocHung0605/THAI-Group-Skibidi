...
- [Support Engineering Job Family](/job-description-library/engineering/support-engineer/)
- [Support Management Job Family](/job-description-library/engineering/support-management/)
...
The [Single Source of Truth](/handbook/company/culture/all-remote/)
...
| [@gitlab-com/support/cmoc](https://gitlab.com/gitlab-com/support/cmoc) | Support members participating in the Communication Manager On-Call rotation |
| [@gitlab-com/support/ceoc](https://gitlab.com/gitlab-com/support/ceoc) | Support members participating in the Customer Emergencies On-Call rotation |
...
Please use the following formats for your name in Zoom as described in [adding your title to your name in Zoom](/handbook/security/corporate/end-user-services/supported-apps/zoom/zoom-additional-config/#customize-your-zoom-profile). As a primarily customer facing team, these formats were chosen to help identify you by vendor and role in calls
