...
GitLab's Team Member contract templates are accessible (for reference) within GitLab only [(here)](https://internal.gitlab.com/handbook/people-group/people-operations/people-operations/employment_contracts/#employment-agreements). The DRI for all GitLab Team Member contracts is the People Operations Team. Any changes to any contracts should be requested to the People Operations Team and will require approval from our Senior Director of Legal, Employment.
...
1. If you have editing rights in the doc, change the document view to "Suggesting" mode (top right corner). If you do not have editing rights, you are able to make a comment on the doc or alternatively ping the People Operations Team member for assistance with having the suggestions added to the contract for approval.
...
If a team member changes roles at GitLab and the approval goes through Greenhouse, the process for a Job Change Letter is laid out in the [Job Change Letter](/handbook/hiring) section on the CES Contract Processes handbook page.
...
The Candidate Experience Specialists will [initiate](/handbook/hiring) all background screenings for candidates. The Senior Background Check Specialist will initiate any applicable retroactive background screenings or requested enhanced background screenings for current team members.
...
The People Operations Team is responsible for managing the probationary period process internally (communication with the team member, their manager, confirmation of probationary period completion, and updating Workday). In some instances, the People Operations Team may also be responsible for managing relationships with legal counsel externally on a global scale to ensure compliance and iteration.
...
If your employment contract was created prior to November 2017, we have created an amendment to the PIAA agreement which can be viewed [here](https://docs.google.com/document/d/1oEfDCIht7Vy6KdcGXWPHZBUXLUUZS9hsvYnOYhQjllg/edit). It amends the 2A section of the PIAA. Please reach out to the People Operations team via [HelpLab](https://helplab.gitlab.systems/esc?id=emp_taxonomy_topic&topic_id=57e1ad3997804e50a326158de053af3d) who will complete and stage the document for signatures. The Amendment will first be signed by the team member and then by the requisite Company signatory.
...
Employees are required to review and acknowledge GitLab's [Code of Business Conduct & Ethics](https://ir.gitlab.com/governance/governance-documents/default.aspx) (aka "CoBCE") upon starting employment at GitLab, and annually thereafter, regardless if there are any changes to the code.

The [People Operations Team](/job-description-library/people-group/people-operations) tracks the Code of Business Conduct & Ethics [signature completion by new hires](https://internal.gitlab.com/handbook/people-group/people-operations/people-operations/onboarding_process/#request-signature-for-code-of-conduct-2021-acknowledgement-of-relocation-2021-consent-to-collect-and-use-data-regarding-race-ethnicity-and-social-media-policy-acknowledgment) during onboarding. The [Ethics & Compliance team](/handbook/legal/ethics-compliance-program/#training) oversees and administers the Code of Conduct refresher training, which requires employees to sign the certification on an annual basis. Completion is tracked in the related learning management platform, Level Up. signature process, which is tracked and distributed through Workday. The annual signature process usually launches in April if every year.
...
1. Add the team member's contract details to the People Operations Task [Tracker](https://docs.google.com/spreadsheets/d/1Z45eOZ2rCRIKgGae3eOKQ8lhIbAPikSs5gLz3V8Kh9U/edit?ts=5e7a2c42#gid=84302455) under the Contracts tab. On the sheet you will assign the People Operations Team member owner, if you are the owner be sure to note the end date and start the below process 2 months before the end date.
...
1. Using the correct contract template from the [templates folder](https://internal.gitlab.com/handbook/people-group/people-operations/people-operations/employment_contracts/#employment-agreements) complete with required team member details. These details can be found on the team member's Workday profile.
...
1. When you have a completed contract be sure to allow a team member to peer review it for you. This can be done by posting the document link in the People Operations private slack channel. Indicate that you are reviewing it by using the 'Eyes' emoji.
...
1. Notify the People Operations team so that they may audit any Workday changes.
1. The People Operations Team member updates the People Operations Task [Tracker](https://docs.google.com/spreadsheets/d/1Z45eOZ2rCRIKgGae3eOKQ8lhIbAPikSs5gLz3V8Kh9U/edit?ts=5e7a2c42#gid=84302455) confirming the contract has been completed.

## Netherlands Renewal Process

1. Two months before the contract ends, HR Savvy will send an email to the People Operations Team member email address.
1. The People Operations Team member that is in charge of allocating contract renewals will assign a member of the People Operations team to complete the contract renewal process.
1. The People Operations Team member adds the team member's contract details to the People Operations Task [Tracker](https://docs.google.com/spreadsheets/d/1Z45eOZ2rCRIKgGae3eOKQ8lhIbAPikSs5gLz3V8Kh9U/edit?ts=5e7a2c42#gid=84302455) under the Netherlands Contracts tab.
1. The People Operations Team member will follow [this HelpLab Job Aid](https://docs.google.com/document/d/1hm707ieQVskaRhBl_89AHq-V3wXbsaiSbYmCiFF3_40/edit) to request approval from the team member's manager two months before the team member's contract ends.
...
- If satisfied with the performance, the manager informs the People Operations team to extend the contract for an indefinite term.
...
1. If a salary increase is required due to updated [visa salary requirements](/handbook/people-group/visas/#right-to-immigrate-to-the-netherlands) the People Operations Team member requests approvals from the team member's manager, total rewards and finally the team member's Division's E-Group leader.
1. The People Operations Team member uploads the approval to the Workday Documents folder.
1. If the contract extension is approved, the People Operations Team member creates the contract
...
1. The People Operations team member stages the contract via Docusign for the [GitLab signatory](/handbook/hiring) and the team member to sign. Add hr@savvy-group.eu to 'Receive a copy' once signed.
...
1. The People Operations Team member uploads the signed contract to the team members Workday Documents folder.
1. The People Operations Team member [updates Workday to reflect the new contract](https://docs.google.com/document/d/1qnRUH2vkBGDi1hWnpGjvfF0G1GvfZLVHUVFuKeu9vKI/edit?usp=sharing): Open the team member's Workday profile > Click on actions > Job Change > add contract. Fill in start and end date, contract type and reason (if applicable)
1. Notify another People Operations Team member so that they may audit any Workday changes.
1. The People Operations Team member updates the People Operations Task [Tracker](https://docs.google.com/spreadsheets/d/1Z45eOZ2rCRIKgGae3eOKQ8lhIbAPikSs5gLz3V8Kh9U/edit?ts=5e7a2c42#gid=84302455) confirming the contract has been completed.
...
- Once signed, CXC will send the renewed contract to People Operations.
- The People Operations Team member uploads the renewed contract to the team member's Workday Contracts & Changes folder and [updates Workday](https://docs.google.com/document/d/1qnRUH2vkBGDi1hWnpGjvfF0G1GvfZLVHUVFuKeu9vKI/edit?usp=sharing) to reflect the new contract.

Standard practice is to automatically renew CXC contracts. The [offboarding process](https://theloop.gitlab.com/site/4455aa7f-24d9-41f2-b940-467b54962e4d/page/0fa19bf4-fd6a-41b9-9316-c2dcf3add854/) will apply should a team member be terminated voluntarily or involuntarily.
