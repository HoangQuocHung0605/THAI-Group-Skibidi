...
description: "Our talent assessment process is how we recognize and grow the people who make GitLab successful. By evaluating performance, identifying growth potential, and spotlighting key talent, we create clarity on where you stand, where you're headed, and how we'll support you getting there."
---
<!-- markdownlint-disable MD051 -->

**Looking for something specific? This page is designed to be a comprehensive resource, which means there's a lot here. Rather than reading start to finish, use the navigation below to jump directly to the questions you're asking or the tasks you need to complete. Each link takes you straight to the information that matters to you.**

### Quick Start: What You Need to Know Now

- [What's happening this Talent Assessment cycle?](/handbook/people-group/talent-assessment/#fy26-talent-assessment--q2-promotion-cycle)

- [What are the key dates I need to remember?](/handbook/people-group/talent-assessment/#timeline)

- [Who participates in this process?](/handbook/people-group/talent-assessment/#eligibility)

### Understanding How We Evaluate Talent

- [Why does GitLab do talent assessments?](/handbook/people-group/talent-assessment/#purpose)

- [How do we look at performance at GitLab?](/handbook/people-group/talent-assessment/#what-is-performance)

- [What does "growth potential" actually mean?](/handbook/people-group/talent-assessment/#what-is-growth)
...
- [What do I need to do as a team member?](/handbook/people-group/talent-assessment/#team-member-self-evaluations)

- [What do I need to do as a manager?](/handbook/people-group/talent-assessment/#matrix-assessment-timeline)

- [Can I use Claude or AI tools to help me?](/handbook/people-group/talent-assessment/#information-guide)

### The Calibration Process

- [What happens during calibration and why does it matter?](/handbook/people-group/talent-assessment/#calibration)

- [How do we ensure this process is fair?](/handbook/people-group/talent-assessment/#calibration-session)

### After the Assessment: What Comes Next

- [How will my manager share results with me?](/handbook/people-group/talent-assessment/#best-practices-for-communicating-performancegrowth-potential-factors)

- [What happens next with my development and growth?](/handbook/people-group/talent-assessment/#sample-next-steps)

### Special Topics

- [How does GitLab identify key talent?](/handbook/people-group/talent-assessment/#key-talent)

- [What is a Single Point Of Failure (SPOF)?](/handbook/people-group/talent-assessment/#single-point-of-failure)

- [What is succession planning and how does it work?](/handbook/people-group/talent-assessment/#succession-planning)

### Manager Resources & Scenarios

- [Sample scripts for delivering assessments](/handbook/people-group/talent-assessment/#sample-script-for-delivering-a-talent-assessment)

- [Common manager scenarios and how to handle them](/handbook/people-group/talent-assessment/#talent-assessment---manager-scenarios)

- [Templates and job aids](/handbook/people-group/talent-assessment/#resources)

## FY26 Talent Assessment & Q2 Promotion Cycle

**Want the quick version?** Here's your TLDR on the next talent assessment cycle …

**New for FY26:** We're combining the talent assessment cycle with Q2 promotion nominations to create a more streamlined experience. This means one assessment window where both performance/growth potential ratings and promotion nominations happen together.

**Quick Timeline:**

- **December 2025:** Get ready - [assessment](https://docs.google.com/document/d/1bdGDq85nY3uLRFLrmKV5RDyQpGkPmnvGAI1pN_RRNto/edit?usp=sharing) template and [promotion document](https://docs.google.com/document/d/1oXH9HzdO8gjqdeosstQRC1Mqt_5lCaN1U2kaF9Av-Ec/edit?tab=t.0#heading=h.2e6gejn4suka) available to start drafting

- **January 12-23, 2026:** Team members complete self-assessment in Workday

- **January 26-30, 2026:**  Managers complete "Assess My Team" in Workday including promotion nominations

- **February 2-27, 2026:** Leadership calibration sessions

- **March 13, 2026:** Manager finalizes and submits team member assessment form

- **March 2026:** Annual Compensation Review (ACR)

- **End of April 2026:** Manager communication window (specific dates to be communicated)

- **May 1, 2026:** Promotions and compensation changes effective

**Want all the details?** Jump to the [full timeline](/handbook/people-group/talent-assessment/#fy26-talent-assessment) for more details, or keep scrolling to learn about our approach, philosophy, and get answers to common questions.

**New to talent assessment at GitLab or need a refresher?** This page covers everything from the "why" behind our process to step-by-step guidance. We encourage you to read through - especially if you're a new manager or haven't been through a cycle with us before.

**Questions?** More details will be shared through January scheduled AMA sessions, or reach out to your People Business Partner.
...
- Review Job Families: Look at the Responsibilities section and how your team member is performing against those responsibilities
  - Example: [Software Engineer in Test](/job-description-library/engineering/software-engineer-in-test#responsibilities)
- Review Performance indicators per Job Family: Look at the Performance indicators.
  - Example: [Software Engineer in Test](/job-description-library/engineering/software-engineer-in-test#performance-indicators)
...
"Developing" growth potential means a team member is not currently showing readiness or interest in taking on significantly greater scope, complexity, or responsibility in the near term (next 12-18 months). This is often because:

- They are too new to the role or company to have demonstrated sustained growth capacity
- They have clearly communicated they are happy in their current role and don't want more responsibility
- They are focused on deepening expertise in their current scope rather than expanding
- They haven't demonstrated interest in or capacity for the four growth potential pillars: Adaptability, Expandability, Consistency, and Self-Awareness

Note: "Developing" growth potential *does not* reflect on current job performance. A team member can be "Exceeding" in performance while "Developing" in growth potential.
...
## FY26 Talent Assessment

### Timeline

The FY26 talent assessment cycle runs from January through April, with promotions and compensation changes effective May 1, 2026. **This cycle combines talent assessments with Q2 promotion nominations** to streamline the process for managers and team members.

Note that different departments may have additional due dates built into the high-level timeline below. Please follow up with your [People Business Partner](/handbook/people-group/people-business-partners/#people-business-partner-alignments) if you have questions specific to your division.

- **December:** Offline versions of [self-assessment](https://docs.google.com/document/d/1bdGDq85nY3uLRFLrmKV5RDyQpGkPmnvGAI1pN_RRNto/edit?usp=sharing) and [promotion document](https://docs.google.com/document/d/1oXH9HzdO8gjqdeosstQRC1Mqt_5lCaN1U2kaF9Av-Ec/edit?tab=t.0#heading=h.2e6gejn4suka) available for early drafting

- **January 12:** Self-assessment opens in Workday for all team members (due: January 23).  *Note*: Self-assessments automatically advance to managers upon submission. Managers can begin their reviews and ratings immediately without waiting for the mass-advance on January 23.

- **January 23:** Incomplete self-assessments are mass-advanced to managers

- **January 26-30:** Manager Talent Assessment ratings and promotion nominations due in Workday (via "Assess My Team")

- **February 2-27:** Leadership calibration sessions

- **February 27:** Calibration window closes, all ratings and nominations finalized

- **March 13:** Manager finalizes and submits team member assessment form in Workday

- **March:** Annual Compensation Review (ACR)

- **End of April:**  Manager communication window (specific dates to be communicated)

- **May 1:** Promotions and cash compensation changes effective

Note: This timeline represents the high-level flow for the combined cycle. More detailed guidance, including specific division timelines and process details, will be shared through your respective People Business Partner, January AMAs, and updated resources as we approach each phase.

*Team members who are on Leave of Absence (LOA) are excluded from the auto advancement of their talent assessment until they return to work.

For full details on our Annual Compensation Review (ACR) timeline and cycle, please refer to our ACR [handbook page](/handbook/total-rewards/compensation/compensation-review-cycle/).

### Cadence

GitLab completes talent assessment annually, with a recommended informal mid-year check-in.

### Eligibility

Anyone hired before October 13, 2025 should receive a Performance and Growth Potential assessment, as they are eligible for Annual Compensation Review. Also refer to the [Too New To Rate description](/handbook/people-group/talent-assessment/#too-new-to-rate).
...
As a baseline, the FY26 Talent Assessment evaluates performance from February 2025 through January 2026. For individuals who received promotions during the year, their final rating should be calibrated against their new level and peer group to appropriately contextualize their performance.

We recommend using Box 4 as the starting baseline for promoted employees, acknowledging that:

- Their full-year contributions earned the promotion and demonstrate strong performance
- They are now being evaluated alongside a new peer set with different expectations
- There is typically an adjustment period as they grow into the increased scope and complexity of the new role
- From this Box 4 baseline, calibrate up or down based on the totality of their year: strong performance throughout the year and exceptional early performance at the new level may warrant upward calibration, while performance challenges or a longer adjustment period may warrant downward calibration.

### Transfers

A "transfer" constitutes a change to one or more of the following: job family, department, division, or job level. (A change in job title specialty or manager alone does not constitute a transfer.) We view transfers differently than we view promotions, as transfers often do not entail compensation increases or job level adjustments.

Team members who transferred during FY26 should be assessed based on their full year of performance. Managers should collaborate with the previous manager to gather feedback on prior role performance and combine it with assessment of current role performance.

**Approach For Transfers**

- Assess the full FY26 performance period across both roles

- Collaborate with previous manager (if applicable) to gather feedback on prior role performance

- Document achievements and growth trajectory in previous role

- Assess ramping and performance in current role since transfer

- Provide combined assessment in written commentary noting the transition timing

- Consider growth potential based on demonstrated trajectory across the full year

*Important Principle:* Transfer during the assessment period should be reflected in the assessment narrative as evidence of growth and development, not used as a reason to exclude team members from formal evaluation. These team members deserve recognition for the performance that led to their advancement.

### New Hires - TNTR Guidance

Team members hired with less than 3 months tenure by January 12, 2026 (hired on/ after October 13, 2025) should be designated as Too New to Rate. While they do not complete a formal talent assessment, managers should still conduct a check-in conversation.

**Self-Assessment for TNTR Team Members**

Team members designated as Too New to Rate are not required to complete a self-assessment. However, completing one can provide value as a structured reflection tool and catalyst for development conversations.

TNTR team members who choose to complete a self-assessment can use it to:

- Reflect on their first months at GitLab or in their new role
Document early achievements and what they've learned during onboarding or ramping

- Frame a check-in conversation with their manager about how they're doing, what support they need, and what expectations look like moving forward

While TNTR team members will not receive a task in Workday to complete their self evaluaton nor receive a formal 9-box rating, they should still have a development-focused conversation with their manager around strengths demonstrated so far, areas for continued growth, and support needed for success.
...
- **Can I use Claude to help me with my self evaluation?**
- Yes. You may use Claude to assist in the preparation of your self evaluation.  Claude can be super helpful to assist you in gathering information about your accomplishments, or helping you brainstorm how you might refine your self evaluation. However, meaningful human input and review is always required, and you should not rely solely on Claude to write your self-evaluation.
...
The Performance/Growth Potential Factor is one of the factors considered in the [Annual Compensation review](/handbook/total-rewards/compensation/compensation-review-cycle/). The recommended increases displayed in the handbook are there to ensure company wide consistency. The factors taken into account for the Annual Compensation Review are:
  - Your hire date (new hires hired on/before October 13, 2025 are ineligible for compensation review)
...
Mid-Year Check-In Timeline (FY2027): (to be updated)
...
| Resource | Purpose |
| ------ | ------ |
| [Workday: Self Assessment & Manager Evaluation Template](https://docs.google.com/document/d/18HPDkzpiWFtCv__lIz-ci8MDFnx5mbv0RF323-WK-Ug/edit?usp=sharing) | Team members and managers can leverage this template to begin thinking through and documenting the optional self-assessment and the manager evaluation for the Talent Assessment. Please note that this template is for team members who would like to get an early start ahead of Workday launching the Talent Assessment cycle, however, all assessments will need to be transferred over to Workday for formal documentation and calibration.  |
| [Workday Job Aid: How to Complete My Annual Self Evaluation](https://docs.google.com/document/d/1OzSKkQYOIxUieNBJP4YWaGcAa3jZ1iKtLDDPSscl0Hw/edit?usp=sharing) | Team member instructions for how to complete their annual Self-Evaluation task in Workday. |
| [Workday Job Aid: How to Complete the Manager Evaluation](https://docs.google.com/document/d/1_K_Nqu7-n7xChYIV1uaM6qLQHFwcCk3tgcgoXGNlNkI/edit?usp=sharing) | Manager instructions for how to complete their Manager Evaluation task. |
| [Workday Job Aid: Assess My Team in Workday](https://docs.google.com/document/d/12yz8vekBOD0UnRuEa1Vbqvy6e9R6Ceeyhpj8REqhoQI/edit?usp=sharing) | Manager instructions for how to complete the Assess My Team's Potential task in Workday. |
| [Workday Job Aid: How to Complete Talent Calibration](https://docs.google.com/document/d/1t5Pmu-_2uIC8r_LK8Ly_uK7aVvIyzhD9-VC8SozVzE0/edit?usp=sharing) | Manager instructions for how to complete their Talent Calibration in Workday. |
| [Calibration Session Guide](https://docs.google.com/document/d/1ZXckP-iBisovqC3Cyzu_MezHQWDbhefywKNPB_0TLNE/edit?usp=sharing) | A comprehensive guide for preparing and running effective, fair calibration sessions.|
...
Key Talent makes up roughly ~10% of the population. Key Talent represents team members who have a significant impact on GitLab's Key Talent represents approximately 10% of our workforce—team members who consistently exceed performance expectations in their current role AND demonstrate strong potential for greater scope and responsibility. They deliver measurable results that advance critical company initiatives while aligning with our values. Team members at any level can be Key Talent.

#### Characteristics of Key Talent

Team members identified as Key Talent:

- Consistently surpass performance expectations with valuable contributions beyond requirements
- Substantially impact the company's ability to achieve significant milestones
- Demonstrate growth potential and desire to assume broader or more complex responsibilities
- Has an outsized, measurable impact on business performance
- Significantly impact critical functional areas
- Has demonstrated the ability to scale with the organization

### Key Talent, Performance, and Growth Potential

Key Talent should typically be assessed as "Exceeding and Growing" or higher [(Boxes 1, 2, or 3)](/handbook/people-group/talent-assessment/#the-performancegrowth-potential-matrix). In rare cases, "Performing and Growing" [(Box 4)](/handbook/people-group/talent-assessment/#the-performancegrowth-potential-matrix) may qualify with strong justification showing exceptional impact AND clear trajectory toward exceeding expectations. Box 4 should be the exception, not the norm.

Team members with less than 3 months tenure ("TNTR" - Too New to Rate) cannot be considered Key Talent.

**Examples of Key Talent:**

- A Staff Engineer who consistently exceeds delivery expectations while driving architectural decisions across multiple teams, led platform improvements reducing system latency by 40%, established technical standards adopted across engineering, mentored three engineers into senior roles, and proactively solved scaling challenges.
- An Account Executive consistently achieving 130-150% of quota while expanding deal sizes by 35% year-over-year, closed strategic reference accounts contributing to enterprise market expansion, developed a discovery methodology now used organization-wide, and mentored two junior AEs who exceeded ramp targets.
- A Senior Manager consistently delivering above team targets while completing two director-level stretch assignments, built scalable processes improving team efficiency by 25%, and developed two direct reports who were promoted.

**NOT Key Talent**

- A Principal Engineer who is the only expert in a critical system but performs at "Performing" level with no demonstrated growth potential (This may signal a ‘single point of failure’ issue requiring succession planning, not Key Talent)
- An Account Executive with deep, hard-to-replace customer relationships but performs at "Performing" level with no interest in increased scope (retention issue, not Key Talent)
- A Manager with 10+ years and institutional knowledge but performs at "Performing" level and is content with current scope (retention strategy needed, not Key Talent)

Note: "Exceeding" performance alone doesn't automatically qualify someone as Key Talent. They must also demonstrate ability and desire for broader responsibilities, outsized business impact, and significant impact on critical functional areas.

### Single Point of Failure

A Single Point of Failure (SPOF) is any person whose failure or absence would cause significant operational disruption, prevent critical work completion, or result in substantial knowledge loss that cannot be readily covered by others.

**CRITICAL DISTINCTION:** Being a SPOF does NOT automatically make someone Key Talent. Key Talent requires surpassing performance expectations AND readiness for greater scope, not only possessing unique knowledge, relationships, or capabilities critical to operations.

### Process to Determine Key Talent

1. Direct managers make initial Key Talent recommendations in Workday during talent assessment (also indicating Performance and Growth Potential assessment and SPOF status)
1. Leaders discuss and calibrate recommendations during divisional calibration sessions
1. E-Group member provides final approval at the divisional level

## Organizational Value

A team member's organizational value should not be determined solely by Key Talent designation. While Key Talent represents ~10% of our workforce, approximately 60-65% are core performers ("Performing") who keep things consistently moving forward. This group is essential to organizational success.

## Impact of Being Identified as Key Talent

We use several engagement tools to retain Key Talent:

- **Learning & Development:** Support Key Talent growth by providing tools and opportunities for personal and professional development.
- **Growth Opportunities:** Discuss motivation and ambitions with Key Talent. Opportunities include expanding scope within current role, lateral moves, or promotions.
- **Compensation:** Our market-based approach differentiates pay based on performance through Annual Compensation Review Cycle and Annual Equity Refresh programs.
- **Succession Planning:** Identify successors for Key Talent roles to mitigate organizational risk.

**Note: Key Talent designation in one year does not guarantee designation in subsequent years.**
...
Key Talent Engagement Discussions can be done at any point during the year, it is not necessary that they are coupled with our Mid year check-in process.
