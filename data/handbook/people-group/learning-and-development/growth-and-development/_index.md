...
If you've never used the Growth & Development Fund before, check out the short instructional course in [Level Up](https://levelup.csod.com/ui/lms-learning-details/app/course/15b39f64-fb22-4cbd-ab93-3021e4f5dd4c) to get a bitesize overview.

We recently significantly reduced our license count in our enterprise agreement with O'Reilly.
...
|[Parentaly](https://gitlab.com/gitlab-com/people-group/learning-development/growth-and-development-requests/-/issues/new?description_template=g-and-d-parentaly_application)|
...
However, they must be expensed separately to your G&D claim, following GitLab’s [Travel and Expense policy](https://internal.gitlab.com/handbook/finance/expenses/#41-travel-related-expenses). Add a link to your G&D issue in the claim description. Please select `Growth and Development` as the Classification for these expenses, but not as the 'Expense Type'.
...
**Description:** Books related to programming, software development, and technical skills that support your career development at GitLab can be reimbursed through the G&D Fund. This is separate from GitLab's [general book reimbursement benefit](https://internal.gitlab.com/handbook/finance/expenses/#books-audioe-books-included) and requires manager approval as part of the G&D process. Books should align with your growth goals and development plan discussed with your manager.
...
>
> We are currently in the process of re-evaluating our G&D coaching vendors to ensure we are partnering with the best possible platforms for our team members. As part of this review, coaching engagements are temporarily paused while we work through an expedited RFP process. We anticipate relaunching the coaching program in Q2 2026.
>
> Interested in coaching? We do not want you to lose your spot! Please fill out the [Coaching Interest Form](https://docs.google.com/forms/d/e/1FAIpQLSfnGW3FE5Ebv-Wel1-tsy9wxueo5AManSy2uuAwNjjiNie8Mw/viewform) and we will make sure you are first in line when the program relaunches. A member of the Growth & Impact team will follow up with you directly.
>
> We appreciate your patience and are excited to come back with an even stronger coaching experience.

Please note, using G&D for coaching is only available for managers and leaders with appropriate job levels. Team members with lower job levels can receive external coaching from [Modern Health](/handbook/total-rewards/benefits/modern-health/#understanding-your-options).

#### Coaching Right Now

**Description:** Professional coaching is available for managers and leaders with appropritate job levels to support development in their professional area of interest. Team members with lower job levels can receive external coaching from [Modern Health](/handbook/total-rewards/benefits/modern-health/) and internal coaching from our [internal resources](/handbook/leadership/coaching/). Team members are expected to know their confidentiality obligations and are responsible for keeping coaching conversations [SAFE](/handbook/legal/safe-framework/).
...
**Reimbursement Requirements:** Remember only managers or Individual Contributors with approprtiate job levels are eligible. Coaching Right Now will invoice GitLab directly for your engagement.
...
Please use the [Parentaly](https://gitlab.com/gitlab-com/people-group/learning-development/growth-and-development-requests/-/issues/new?issuable_template=g-and-d-parentaly) issue template to open requests of this type.

**Description:** Parentaly is an expert-led program available globally to all team members planning to go on parental leave - including birthing and non-birthing parents. The program provides personalized 1:1 support before, during, and after leave to help you build a strong coverage plan, transition work effectively, and return to work with confidence. You'll gain access to templates, a personalized toolkit and materials, plus up to nine sessions with a dedicated Parentaly Expert who has supported hundreds of others through parental leave.

Parentaly costs $2,500 and is funded through your G&D allowance. However, **unlike most G&D opportunities, you do not pay upfront and apply for reimbursement.** GitLab pays Parentaly directly on your behalf - you simply sign up after receiving manager approval on your G&D issue.

We recommend signing up at least 2-3 months before your leave begins to get the full benefit of the program, though sign-ups are accepted at any point in your leave journey, including when you're returning to work.

**Reimbursement Requirements:** Parentaly invoices GitLab directly. There is no payment or reimbursement action required from you. After receiving manager approval on your G&D issue, proceed directly to [sign up for the Parentaly coaching program](https://www.parentaly.com/join/coaching-program/gitlab).

Managers can also access support through Parentaly by activating a [Manager Toolkit](https://gitlab.parentaly.com) or attending [Manager Training](https://www.parentaly.com/join/events/manager-training), which provides real-time support and access to guides and resources for leading effectively through parental leave transitions.
...
If multiple team members are applying for the same opportunity (e.g., attending the same conference or completing the same training), please follow these guidelines:

**Application Process:**

- Submit one issue for the group rather than individual applications for each person.

**Payment and Reimbursement:**

- Each team member must pay for their own expenses and process their own reimbursement through Navan.
- Managers or colleagues should not cover expenses on behalf of others, as reimbursements count against each individual's Growth and Development allowance.
- All expenses must be claimed through the standard Navan reimbursement workflow after completing the course or attending the conference.

## Company-Directed Learning Opportunities

The Growth and Development policy supports individual career development chosen by team members. Company-directed learning, such as mandatory conferences or training required to fulfill job duties, falls outside the scope of this policy and should be budgeted separately through appropriate department channels.

## FAQ: Team-Wide Training

**Can I use the G&D Fund to arrange training for my entire team?**

No. The G&D Fund is designed for individual career development, and each team member has their own allocation to use as they see fit. If you want to arrange training for your whole team, this should be budgeted outside the G&D Fund. Please discuss this with your manager and your department's FP&A Partner to explore appropriate funding options.
