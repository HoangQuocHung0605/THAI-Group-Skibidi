...
We have [Merge Request Coaches](/job-description-library/expert/merge-request-coach/) who help contributors get their merge requests to meet the [contribution acceptance criteria](https://docs.gitlab.com/ee/development/contributing/merge_request_workflow.html#contribution-acceptance-criteria),
...
1. Is the person or organization submitting this using GitLab in an [SMB](/handbook/sales/)?
